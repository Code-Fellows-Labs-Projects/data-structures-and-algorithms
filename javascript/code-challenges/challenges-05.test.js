...
const toLastNames = people => {
  let newArray = people.map((value) => value.firstName + ' ' + value.lastName);
  return newArray;
};
...
------------------------------------------------------------------------------------------------ */
const addValues = (arr) => {
  let sumTotal = arr.reduce((accumulator, currentValue) => {
...
const addPurchases = (arr) => {
  let amountPurchased = arr.reduce((accumulator, currentValue) => {
...
const countNumberOfElements = (arr) => {
  let numberOfElements = arr.reduce((accumulator) => {
...
const returnNames = (arr) => {
  const characterNames = arr.reduce((accumulator, character) => {
...
const reversedString = (str) => {
  ...
  const reversed = splitArr.reduce((newString, currentLetter) => {
...
const calculateAverage = (arr) => {
  const findAverageOfNumbers = arr.reduce((accumulator, currentNumber) => {
    let count = accumulator.count + 1;
    let sum = accumulator.sum + currentNumber;
    return {count: count, sum: sum};
  }, { count: 0, sum: 0 });
  return findAverageOfNumbers.sum / findAverageOfNumbers.count;
};
...
const countPrimeNumbers = (arr) => {
  const primeNumberCount = arr.reduce((accumulator, currentNumber) => {
    return isPrime(currentNumber) ? accumulator + 1 : accumulator;
  }, 0 );
